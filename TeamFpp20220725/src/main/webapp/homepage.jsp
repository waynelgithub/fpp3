                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <form class="navbar-form navbar-left" >
                            ...
                            <button style="width:60px" type="button" class="btn btn-default btn-search">搜索</button><a href="acctlogin">&emsp; 登入</a><a href="memberCreate">&emsp; 註冊</a>					
						</ul>
                            <!--<div class="login_out">
					            <a href="acctlogin">登入</a>
					        </div>-->
                        </form>
