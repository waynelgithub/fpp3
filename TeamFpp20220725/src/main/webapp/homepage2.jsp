  ...
  <div class="container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li id="shuma"><a href="#">台北市 <span class="sr-only">(current)</span></a></li>
                            <li id="meizhuang"><a href="#">新北市</a></li>
                            <li id="shuji"><a href="#">台中市</a></li>
                            <li id="shipin"><a href="#">台南市</a></li>
                            <li id="fushi"><a href="#">高雄市</a></li>
                        </ul>
                        ...
                        <li ><img class="img-circle" src="${pageContext.request.contextPath}/image/logo.png" style="width:60px;height:60px"></li>
							 <li ><a href="#"  data-target=".login">${sessionScope.M.name}</a></li>					
						</ul>
                        <!-- 模态框 -->
                    </div>
                    <!-- /.navbar-collapse -->
        ...
        <div class="row">
            <header class="col-md-2">
                <div class="logo">
                    <a href="userlist">
                        <img src="${pageContext.request.contextPath}/image/logo.png" alt="" class="hidden-xs">
                        <span class="visible-xs">房屋買賣交易</span>
                    </a>
                </div>
                 <div class="nav">
                     <ul>  
                            <li id="shuma1"><a href="#"><i class="twicon-taipei101"></i>&thinsp;&thinsp;台北市<span class="sr-only">(current)</span></a></li>
                            <li id="meizhuang1"><a href="#"><i class="twicon-queens-head"></i>&thinsp;&thinsp;新北市</a></li>
                            <li id="shuji1"><a href="#"><i class="twicon-tunghai-uni "></i>台中市</a></li>
                            <li id="shipin1"><a href="#"><i class="twicon-provintia "></i>&thinsp;台南市</a></li>
                            <li id="fushi1"><a href="#"><i class="twicon-85tower"></i>&thinsp;&thinsp;高雄市</a></li>
                    </ul>
                </div>
            </header>
            ...
            <article class="col-md-7">
                ...
                <div class="news clearfix" style="width:850px">
                    <ul>
                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                        <img src="${pageContext.request.contextPath}/image/01.jpg" alt="...">
                        ...
                        <li>
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/image/04.jpg" alt=" ">
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/image/05.jpg" alt="">
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/image/06.jpg" alt="" >
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/image/07.jpg" alt="">
                            </a>
                        </li>
